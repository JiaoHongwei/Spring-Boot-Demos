package com.hw.springbootprotostuff.config;
...
public class ProtostuffHttpMessageConverter extends AbstractHttpMessageConverter<Object> {
    ...
    private static final MediaType MEDIA_TYPE = new MediaType("application", "x-protostuff", DEFAULT_CHARSET);
    ...
    protected Object readInternal(final Class<?> clazz, final HttpInputMessage inputMessage) throws IOException, HttpMessageNotReadableException {
        ...
        throw new HttpMessageNotReadableException("Unrecognized HTTP media type " + inputMessage.getHeaders().getContentType().getType() + ".", inputMessage);
    }
